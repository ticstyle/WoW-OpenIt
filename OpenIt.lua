...
local function HasUnmetRequirements(bag, slot, itemID, info)
    ...
    for _, lineData in ipairs(tooltipData.lines) do
        ...
        if lowerClean:find("restores %d+ health")
...
local function FastCanBeOpenable(itemID, info)
    ...
    if classID then
        ...
        if classID == Enum.ItemClass.Consumable and subClassID then
            ...
            elseif subClassID == 1 or subClassID == 2 or subClassID == 3 or subClassID == 4
                or subClassID == 5 or subClassID == 6 or subClassID == 7 or subClassID == 9 or subClassID == 10
            then
                return false
            end
        end

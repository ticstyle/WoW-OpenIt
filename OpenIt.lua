...
local function HasUnmetRequirements(bag, slot, itemID, info)
    ...
    for _, lineData in ipairs(tooltipData.lines) do
        ...
        if lowerLine:find("already known") or lowerLine:find("already collected") or lowerLine:find("<already known>") then
            return true
        end
            ...
            for _, lineData in ipairs(tooltipData.lines) do
                ...
                if text and text ~= "" then
                    ...
                    if cleanText:find("Use:") or cleanText:find("Använda:") then
                        if lowerText:find("study to increase")
